...
- A registry at `/Users/hunterbrewer/Desktop/School/school.json` mapping course name to its grades file. May not exist yet -- Mode 1 creates or updates it.
...
6. Update `/Users/hunterbrewer/Desktop/School/school.json`: a JSON object keyed by course name, e.g. `{"4610": {"grades_file": "/Users/hunterbrewer/Desktop/School/Summer 26/4610/Grades/grades.json"}}`. If the registry file doesn't exist, create it with just this course's entry. If it exists, merge this course's entry in without touching any other course's entry.
